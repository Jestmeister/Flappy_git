    ...
    while True:
       ...
       # print("Step:"+str(step))
        ...
        if cr_tst:
            ...
            X = torch.rand(6, device=device)
            print(X)
            #X=torch.FloatTensor(inputHistory[:, 0], device=device)
            a=inputHistory[0,0].copy()+0.0001
            print(type(a))
            print(type(X[0]))
            ...
            print(a)
            #torch.FloatTensor(inputHistory[:, 0].tolist(), device=device)
            print(X)
            X=torch.FloatTensor(inputHistory[:, 0].tolist(), device=device)/100
            print(X)
            time.sleep(5)
            ...
            for d in range(0,1000):
                ...
                Qvalues = model(X)
                print(Qvalues)
#                Qvalues = model(torch.FloatTensor(inputHistory[:, 0], device=device))
                print(Qvalues)
